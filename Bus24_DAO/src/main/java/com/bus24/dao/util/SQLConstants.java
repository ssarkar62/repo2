...
public class SQLConstants {
	...
	public static final String SQL_SELECT_INSURANCE_COMPANY_BY_TRAVELID = "select company_id,company_name,amount,t.travel_id,travel_name from insurance i join  travels t on t.travel_id=i.travel_id where t.travel_id=?";
